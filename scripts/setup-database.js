...
-- Function to automatically add message sender as a member
...
-- Trigger to automatically add message sender as a member
  ...
  try {
    ...
    for (const statement of statements) {
      ...
      if (error) {
        ...
        // Don't exit on error as some statements might fail if they already exist
      }
    }
