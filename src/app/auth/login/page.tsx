...
export default function LoginPage() {
  ...
  const handleOAuthLogin = async (provider: 'google' | 'github' | 'discord') => {
    ...
    try {
      ...
      // Note: signInWithOAuth will redirect the user, so we don't need to do anything here
    } catch (err: any) {
        ...
        {authMethod === 'oauth' && (
          <div className="space-y-4">
            <button
              ...
              disabled={isLoading}
              className="w-full py-3 bg-white rounded-xl text-gray-900 font-bold hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full py-3 bg-gray-900 rounded-xl text-white font-bold hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center justify-center gap-2"
            >
